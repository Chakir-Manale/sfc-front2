...
import VariantsByCategory from "../components/home/variants-by-category";

export default function ProductsRoute() {
    return (
        <Switch>
            <Layout>
                <Route exact path={ `${process.env.PUBLIC_URL}/product/by/category/:id` } component={ VariantsByCategory } />
