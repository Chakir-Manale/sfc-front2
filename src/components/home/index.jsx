    ...
    return (
        <>
            ...
            <header className="header-bottom">
                <div className="header-bottom__banner owl-theme">
                    <div className="slide-item">
                        ...
                        <div className="container">
                            <div className="slide-item__block" style={{opacity: "100"}}>
                ...
                <div className="container">
                    <div className="about__our-misson wow fadeInLeft">
                        ...
                        <div className="about__our-misson-text">
                            ...
                            <p className="text">Our mission is to raise awareness towards environment knowledge,<br/>
                    ...
                    <div className="about__text wow fadeInRight">
                        <h4>who we are</h4>
                        <h1 className="section-title">Goal Diggers<br/><span>For a brightest futur!</span></h1>
                        <p>
                        ...
                        <a href="https://workspace-sfc.herokuapp.com" className="read-more">Join us!</a>
                        <div className="about__text-signature">
                            <img src="assets/images/png/signature.png" alt="signature"/>
                            <h4>SFC<br/><span>Goal Diggers</span></h4>
                        </div>
                    </div>
                </div>
            </section>
