...
import { mainSlider4, mainSlider3, mainSlider2 } from '../settings';
                ...
                <div className="container">
                    <div className="about__our-misson wow fadeInLeft">
                        ...
                        <div className="about__our-misson-text">
                            ...
                            <p className="text">Our mission is to care for patients,<br/>families, communities, and one another
                            </p>
                        </div>
                ...
                <div className="container">
                    ...
                    <div className="other-services__cards">
                        <div className="card-item">
                            ...
                            <h4 className="subtitle">Health Help Centre provives<br/>the following healthcare Services:</h4>
                            <ul className="lists">
                        ...
                        <div className="card-item">
                            ...
                            <h4 className="subtitle">A lifestyle of holistic wellness rewards<br/>you with enhanced health:</h4>
                            <ul className="lists">
                            ...
                            <Link to="#" key={index} className={"latest-news__item"}>
                                <div className="inner-block">
                                    <div className="img">
                                        ...
                                        <h1 className="date">{article.date}</h1>
                                    </div>
