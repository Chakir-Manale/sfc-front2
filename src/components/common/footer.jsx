...
function Footer( props ) {
    return (
            ...
            <div className="container">
                ...
                <div>
                    <div className="footer__top-blocks">
                        ...
                        <div className="content">
                            <p className="text">To receive email releases, simply provide us with your email address below.
                            </p>
                            <form>
                                <div className="email">
                    ...
                    <div className="footer__top-blocks">
                        ...
                        <div className="content">
                            <ul className="menu">
                                ...
                                <li>
                                    <a href="#why-us"><i className="fa fa-angle-right"></i>Why Us</a>
                                </li>
                                <li>
                                    <a href="#faq"><i className="fa fa-angle-right"></i>FAQ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div className="footer__bottom">
            <p>Copyright &copy; 2021 TEAM X | MC</p>
        </div>
    </footer>
    );
}
