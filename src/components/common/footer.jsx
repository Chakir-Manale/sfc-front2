    ...
    return (
        <footer className="footer">
                ...
                <div className="container">
                        ...
                        <div className="footer__top-blocks">
                            ...
                            <div className="content">
                                ...
                                <div className="content-item">
                                    ...
                                    <div className="text">
                                        <p>American Space Oujda 60000</p>
                                    </div>
                                </div>
                                <div className="content-item">
                                    <div className="icon">
                                    ...
                                    <div className="text">
                                        <a href="mailto:chakirmanale@gmail.com">chakirmanale@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div className="footer__top-blocks">
                            ...
                            <div className="content">
                                <p className="text">To receive email releases, simply provide us with your email address
                                    below.
                                </p>
                                <form>
                                    <div className="email">
                        ...
                        <div className="footer__top-blocks">
                            ...
                            <div className="content">
                                <ul className="menu">
                                    <li>
                                        <a href="#about"><i className="fa fa-angle-right"></i>About Us</a>
                                    </li>
                                    <li>
                                        <a href="#services"><i className="fa fa-angle-right"></i>Services</a>
                                    </li>
                                    <li>
                                        <a href="#why-us"><i className="fa fa-angle-right"></i>Blog</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div className="footer__bottom">
                <p>Copyright &copy; 2021 Goal-Diggers | MC</p>
            </div>
        </footer>
    );
}
