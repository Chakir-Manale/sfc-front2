                ...
                type === "product" ?
                    <div className={`${container}  d-flex align-items-center`}>
                        ...
                        <nav className="product-pager ml-auto" aria-label="Product">
                            <Link className="product-pager-link product-pager-prev"
                                ...
                                <span>Prev</span>
                                {
                                    prevProduct ?
                                        <div className="product-detail">
                                            <figure>
                                                <img src={process.env.PUBLIC_URL + '/' + prevProduct.pictures[0]}
                                                     alt="Product"/>
                                            </figure>
                            ...
                            <Link className="product-pager-link product-pager-next"
                                  to={`${process.env.PUBLIC_URL}/${type}/${slug}/${nextProduct.id}`} aria-label="Next"
                                  tabIndex="-1">
                                <span>Next</span>
                                ...
                                <i className="icon-angle-right"></i>
                                {
                                    nextProduct ?
                                        <div className="product-detail">
                                            <figure>
                                                <img src={process.env.PUBLIC_URL + '/' + nextProduct.pictures[0]}
                                                     alt="Product"/>
                                            </figure>
