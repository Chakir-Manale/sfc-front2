    ...
    return (
        <nav className="mobile-nav">
            <ul className="mobile-menu">
                ...
                <li className={''}>
                    <Link to={`${process.env.PUBLIC_URL}/pages/about`}>À propos</Link>
                </li>
                ...
                <li className={''}>
                    <Link to={`${process.env.PUBLIC_URL}/pages/cgv`}>Conditions Générale d'Utilisation</Link>
                </li>
                ...
                {/*        <li><Link to={ `${process.env.PUBLIC_URL}/pages/cgv` }>FAQs</Link></li>*/}
