        ...
        <>
            <div className="toolbox">
                <div className="toolbox-left">
                    <button className="sidebar-toggler" onClick={showSideBar} style={{padding: "0"}}><i
                        className="icon-bars"></i>Filters
                    </button>
                </div>
            ...
            <div className="load-more-container text-center">
                {
                    hasMore ?
                        <button className="btn btn-outline-darker btn-load-more" onClick={loadMore}>
