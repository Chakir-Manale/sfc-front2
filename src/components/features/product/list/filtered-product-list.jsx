...
function FilteredProducts(props) {
    ...
    useEffect(() => {
        variants = getVisibleProducts(props.variants.slice(0, 8), filters);
    ...
    return (
        variants.length > 0 ?
            ...
            <div className="container" style={{textAlign: 'center', marginBottom: '5%', marginTop: '5%'}}>
                <span style={{fontSize: '15px', fontWeight: 'bold'}}>Il n'y a pas de produits dans cette catégorie.</span>
            </div>
    );
}
...
export default connect(mapStateToProps, {addToCart})(FilteredProducts);